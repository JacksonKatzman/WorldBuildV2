...
namespace Game.Visuals.Hex
{
	...
	{
		public static int MAP_SIZE_X = 80;
		public static int MAP_SIZE_Z = 60;
		...
		void CreateLand()
		{
			...
			if (landBudget > 0)
			{
				OutputLogger.Log("Failed to use up " + landBudget + " land budget.");
			}
		}
		...
		void EvolveClimate(int cellIndex)
		{
			...
			//Also, the wind direction defines the direction from which the wind blows. So we need to use the opposite of that as the main dispersal direction.
