...
namespace Game.Factions
{
	public class FactionSimulator : ITimeSensitive, IRecordable
	{
		...
		public FactionSimulator(Tile startingTile, float food, int population)
		{
		...
		public void UpdateMilitary()
		{
			...
			if(foodSurplus > population * 1.2f)
			{
				...
				foreach (FactionSimulator faction in world.factions)
				{
		...
		public void ModifyFactionTension(FactionSimulator faction, float amount)
		{
		...
		public void ModifyFactionTensionByPercentage(FactionSimulator faction, float amount)
		{
			if (factionTensions.ContainsKey(faction))
			{
		...
		public void SetFactionTension(FactionSimulator faction, float amount)
		{
			if (factionTensions.ContainsKey(faction))
			{
				factionTensions[faction] = amount;
