...
namespace Game.GameMath
{
	public class Polygon
    {
		...
		{
            Points = new PointF[points.Count];
        ...
        public float PolygonArea()
        {
            ...
            // oriented clockwise.
            return Mathf.Abs(SignedPolygonArea());
        }
        ...
        private void FindInitialControlPoints()
        {
			...
			System.Diagnostics.Debug.Assert(false, "Could not find initial control points.");
        }
        ...
        private bool FindIntersection(float X1, float Y1, float X2, float Y2, float A1, float B1, float A2, float B2, ref PointF intersect)
        {
            ...
            if (Mathf.Abs(da * dy - db * dx) < 0.001) return false;
        ...
        public PointF[] FindSmallestBoundingRectangle()
        {
			...
			System.Diagnostics.Debug.Assert(!this.PolygonIsOrientedClockwise());
